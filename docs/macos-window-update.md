...
- The macOS icon is generated by `scripts/create_macos_icon.py` (Python + Pillow). This updates the ten macOS asset-catalog sizes, the legacy iconset, and ICNS. The iOS artwork is unchanged.
